...
<body onload="startTime()">
    <div class="container" style="width: 500px;">
        {{template "navbar" .}}
        <form class="form-horizontal" method="POST" action="/micropay">
            ...
            <div class="form-group">
                <label class="col-lg-4 control-label">Openid：</label>
                <div class="col-lg-6">
                    <input id="openid" class="form-control" name="openid" placeholder="openid">
                </div>
            </div>
            <div class="form-group">
                <div class="col-lg-offset-2 col-lg-10">
                    <a href="/micropay" target="_blank">
